	...
	namespace Core {
		...
		Class Application {
			...
			public static function setClient( $force = null ){
				...
				self :: $app->requestURI = implode('/', $req );
				...
				if( strlen(self :: $app->request[0]) > 0 ){
			...
			/**
			 *	Shortcut method to return 
			 *	the variables from Router
			 * 
			 *	@since 0.1.0
			 *	@return object Router variables
			 */
			public static function request(){
				return Router :: getRouteVars();
			}
